...
export function traverse<Reflected extends unknown, Output extends unknown>(t: Type<Reflected>, f: (input: Reflected) => Output) {
	return function traverse(input: Reflected) {
		return f(input);
	}
}
